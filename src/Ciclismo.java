...
{
	private static String nome="Ciclismo";
	public static String getNome(){
		return Ciclismo.nome;
		}
	private int distancia;
	private int avgSpeed;
	private int altMin, altMax;
	
	public Ciclismo(int duracao,
	...
	public Ciclismo(Ciclismo other){
		super(other.getDuracao(),other.getData_atividade(),other.getTemperatura(),other.getCondicoes_met());
	...
	public double calcBurnCals(){
		return this.getDuracao()*this.getAvgSpeed()*0.00802;
	}
